...
class BotSheetAddToList extends StatefulWidget {
  final Grocery grocery;
  final String btnLabel;
  final String succesLabel;
  final bool showSucces;
  const BotSheetAddToList({
    super.key,
  ...
  @override
  State<BotSheetAddToList> createState() => _BotSheetAddToListState();
}

class _BotSheetAddToListState extends State<BotSheetAddToList> {
